namespace Xilium.CefGlue
{
    ...
    public sealed unsafe partial class CefImage
    {
        ...
        {
            if (pixelData == IntPtr.Zero) throw new ArgumentNullException("pixelData");
            if (pixelDataSize < 0) throw new ArgumentOutOfRangeException("pixelDataSize");
        ...
        {
            if (pngData == IntPtr.Zero) throw new ArgumentNullException("pngData");
            if (pngDataSize < 0) throw new ArgumentOutOfRangeException("pngDataSize");
        ...
        {
            if (jpegData == IntPtr.Zero) throw new ArgumentNullException("jpegData");
            if (jpegDataSize < 0) throw new ArgumentOutOfRangeException("jpegDataSize");
